...
public class AudioSessionManager {
    ...
    public func configureForRecording() throws {
        ...
        do {
            ...
            Logger.audio.info("Audio session configured for recording: category=playAndRecord, sampleRate=44100Hz")
            FileLogger.shared.log(level: "INFO", category: "audio", message: "Audio session configured for recording: category=playAndRecord, sampleRate=44100Hz")
        } catch {
    ...
    public func configureForRecordingAndPlayback() throws {
        ...
        do {
            ...
            Logger.audio.info("Audio session configured for recording and playback: category=playAndRecord with full Bluetooth support")
            FileLogger.shared.log(level: "INFO", category: "audio", message: "Audio session configured for recording and playback")
        } catch {
            Logger.audio.logError(error)
